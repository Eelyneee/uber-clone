  ...
  <div id="Home" class="flex flex-col h-screen">
    <div class="m-3 mb-auto">
      ...
      <div class="grid grid-cols-2 gap-3 my-3">
        <ServiceSelectLarge @click="router.push('/directions')" text="Ride" image-width="74" image="ride" />
        <ServiceSelectLarge text="Food" image-width="72" image="food" :promo="true" />
      </div>
      ...
      <div @click="router.push('/directions')" class="w-full bg-custom-color h-14 rounded-full flex items-center p-3">
        <MagnifyIcon :size="40" />
