<template>
  <div id="AutoCompleteInput" class="flex items-center">
    <input :id="theId" v-model="inputCompleted" @click="emit('isActive', true)" class="text-md bg-gray-100 appearance-none w-full py-2.5 px-3
    text-gray-700 leading-tight focus:tight focus:outline-none focus:shadow-outline
    focus:bg-gray-200" typre="text" :placeholder="placeholder" autocomplete="off">
